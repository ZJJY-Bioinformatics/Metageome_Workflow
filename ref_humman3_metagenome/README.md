...
```
nohup /data3/Group7/wangjiaxuan/biosoft/miniconda3/envs/meta/bin/python /data3/Group7/wangjiaxuan/script/qsub_delh2.py -s 1 -g 100g -c 8 -l 8 --mn -r run_main.sh -b 1 &
```
...
```
nohup /data3/Group7/wangjiaxuan/biosoft/miniconda3/envs/meta/bin/python /data3/Group7/wangjiaxuan/script/qsub_delh2.py -s 1 -g 100g -c 8 -l 8 -r ref_metagenome_step2.sh &
```
...
运行：
```
nohup /data3/Group7/wangjiaxuan/biosoft/miniconda3/envs/meta/bin/python /data3/Group7/wangjiaxuan/script/qsub_delh2.py -s 1 -g 100g -c 8 -l 8 -r ref_metagenome_step3.sh &
```
